...
{
	public static var orlVersion:String = '1.0.0';
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('orlBG'));
		...
		magenta = new FlxSprite(-80).loadGraphic(Paths.image('orlBG'));
