...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		char = new FlxSprite(420, 50).loadGraphic(Paths.image('mainmenu/inflamed_fnf_assets'));
		char.frames = Paths.getSparrowAtlas('mainmenu/inflamed_fnf_assets');
		char.animation.addByPrefix('idle', 'INFLAMED IDLE', 24, true);
		char.animation.play('idle');
		char.scrollFactor.set();

		var startTxt:FlxText = new FlxText(500, 500);
		startTxt.text = 'START';
		startTxt.setFormat(Paths.font("sonic.ttf"), 32);
		startTxt.size = 64;
		...
		var bgYellow:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 386, 0xFFFF0000);
