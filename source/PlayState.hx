...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'kls': //kill streak
				var kls:BGSprite = new BGSprite('exeller/stage', -600, -200, 0.9, 0.9);
				add(kls);

			case 'piracy': //unwanted pirate
				var piracy:BGSprite = new BGSprite('piracy/stage', -600, -200, 0.9, 0.9);
				add(piracy);

			case 'inflame': //foraging
				var inflame:BGSprite = new BGSprite('foraging/stage', -600, -200, 0.9, 0.9);
				add(inflame);
		...
		if(curSong == 'foraging'){
			...
			GameOverSubstate.characterName = 'pp-dead';
		}
	}
	...
	override public function update(elapsed:Float)
	{
	 	...
	 	switch (SONG.song.toLowerCase()) //ass code
		{
			...
			case 'perfection':
				scoreTxt.text = 'Score: PERFECT' + ' | Combo Breaks: 0/0';
